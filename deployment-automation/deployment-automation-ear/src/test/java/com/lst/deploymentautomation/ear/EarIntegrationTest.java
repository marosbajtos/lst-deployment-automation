...
public class EarIntegrationTest {

	@Test
	public void testEarLibs() throws ZipException, IOException {
		...
		assertEquals("Invalid number of ear files", 1, warFiles.length);

		File warFile = warFiles[0];

		PackagingTestHelper helper = new PackagingTestHelper();
		helper.loadFiles(warFile, "lib/");
